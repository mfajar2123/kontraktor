...
<template>
  <div>
    <HeroSection />
    <section class="technology-strip" aria-label="Core technologies">
      <div class="shell">
    ...
    <section class="section shell" aria-labelledby="capabilities-title">
      <div class="section-heading">
        ...
        <p>From the first interaction<br />to the infrastructure behind it.</p>
      </div>
      <div class="capability-grid">
        <article v-for="item in capabilities" :key="item.no" class="capability">
          <div class="card-top">
